...
\begin{document}
  ...
  \begin{frame}{Hamiltonian formalism}
    \begin{alertblock}{}
      \item The Hamiltonian generate the time evolution of any function of
        canonical variable $F(Q_i, P_i)$ via the \emph{Poisson Bracket}
